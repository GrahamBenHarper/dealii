...
#include <deal.II/fe/fe_poly2.templates.h>
...
template <>
void
FE_Poly2<TensorProductPolynomials<1>, 1, 2>::fill_fe_values(
...
template <>
void
FE_Poly2<TensorProductPolynomials<2>, 2, 3>::fill_fe_values(
