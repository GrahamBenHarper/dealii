...
#ifndef dealii_fe_poly2_h
#define dealii_fe_poly2_h
...
/**
 * This class is a duplicate of FE_Poly with the exception that it
 * does not have a template argument for PolynomialType. This is
 * part of an effort to slowly migrate finite element classes from
 * using the PolynomialType template.
 * 
...
class FE_Poly2 : public FiniteElement<dim, spacedim>
{
public:
  /**
   * Constructor.
   */
  FE_Poly2(const ScalarPolynomialsBase<dim> &poly_space,
...
protected:
  ...
  /**
   * A pointer to the polynomial space.
   */
